...
> Los SDKs de Data Pipeline de OptiKPI son librerías cliente oficiales para la API de ingesta del Data Pipeline. Gestionan autenticación, validación y reintentos para que puedas enviar perfiles de cliente y datos de eventos desde tu backend con poco código.

## SDKs oficiales

Elige tu lenguaje. Cada tarjeta enlaza a instalación, configuración y uso de ese SDK.

<div class="sdk-card-group">

<a class="sdk-card" href="/es/data-pipeline-sdk/javascript">
  ...
  <p class="sdk-card-desc">Usa la API de Data Pipeline desde Node.js o el navegador. Instalación vía npm; soporta CommonJS y ESM.</p>
</a>

<a class="sdk-card" href="/es/data-pipeline-sdk/java">
  <span class="sdk-card-icon">
  ...
  <p class="sdk-card-desc">Cliente Java 11+ con Maven. Modelos tipados, validación y soporte por lotes.</p>
</a>

<a class="sdk-card" href="/es/data-pipeline-sdk/python">
  <span class="sdk-card-icon">
  ...
  <p class="sdk-card-desc">Cliente Python 3.8+. Uso con pip o Poetry; incluye modelos y validación.</p>
</a>

<a class="sdk-card" href="/es/data-pipeline-sdk/php">
  <span class="sdk-card-icon">
  ...
  <p class="sdk-card-desc">Cliente PHP 7.4+ vía Composer. Requiere ext-json, ext-curl, ext-openssl.</p>
</a>
...
Todos los SDKs soportan los mismos tipos de datos y claves de lote. Los campos obligatorios y esquemas a nivel de campo están en la [Guía de integración](/es/data-pipeline-sdk/integration-guide).

| Type                          | Description                                                          |
| ----------------------------- | -------------------------------------------------------------------- |
| **Customer profiles**         | Información de cuenta, preferencias, límites, estado de verificación |
| **Account events**            | Login, logout, registro, verificación                                |
| **Deposit / Withdraw events** | Transacciones financieras                                            |
| **Gaming activity events**    | Apuestas, ganancias, sesiones de juego, slots, deportes, póker       |
| **Wallet balance events**     | Instantáneas y actualizaciones de saldo                              |
| **Refer friend events**       | Referidos y recompensas                                              |
| **Extended attributes**       | Datos clave-valor personalizados por usuario/lista                   |

::: tip Obtener credenciales
Necesitas un **token de autenticación**, **ID de cuenta**, **ID de workspace** y **URL base de la API** de tu gestor de cuenta. El SDK los usa para firmar las peticiones (HMAC + HKDF); no hace falta código de criptografía por tu parte.
:::

## Siguientes pasos

1. Elige un SDK arriba y abre su página para **Instalación** y **Configuración**.
2. Lee la [Guía de integración](/es/data-pipeline-sdk/integration-guide) para endpoints, límites de tasa, manejo de errores y detalles del modelo de datos.
3. Ejecuta los ejemplos del [repositorio del SDK](https://github.com/gamingcrafts/optikpi-datapipeline-sdk) tras configurar `.env` con tus credenciales.
